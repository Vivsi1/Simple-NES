...
public:
    ...
    std::array<Color, 64> systempalette{
        ...
        Color{0x00, 0xFC, 0xFC}, Color{0xF8, 0xD8, 0xF8}, Color{0x00, 0x00, 0x00}, Color{0x00, 0x00, 0x00}}; // Initialise NES system palette
    ...
    bool suppress = false;
    bool bgVisibleThisFrame = false;
    bool bgWasVisibleLastFrame = false;
    long long bgDisappearFrame = 0;
    bool sprite0VisibleThisFrame = false;
    bool sprite0WasVisibleLastFrame = false;
    long long sprite0DisappearFrame = 0;
